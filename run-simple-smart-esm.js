/**
 * Simple Smart Recommendations Runner (ES Module Version)
 * This script runs the simplified version of our Smart Recommendations server
 * This uses ES modules format to match the project configuration
 */
...
const serverProcess = exec('node simple-smart-server-esm.js', (error, stdout, stderr) => {
  if (error) {
